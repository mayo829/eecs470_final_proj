module t1();
    ...
    logic ADDR squashed_new_PC_in;
    logic [63:0] Icache2proc_data_in;
	logic [`SCALAR-1:0] ADDR bp_pc;
    logic ADDR proc2Icache_addr_out;
	IF_ID_PACKET  [`SCALAR-1:0] if_packet_out;   // Output data packet from IF going to ID, see sys_defs for signal information 
