...
`endif
        ...
        .id_ROB_NPC_dbg   (id_ROB_NPC_dbg),
        .id_ROB_inst_dbg  (id_ROB_inst_dbg),
        .id_ROB_valid_dbg (id_ROB_valid_dbg),
        .id_RS_NPC_dbg    (id_RS_NPC_dbg),
        .id_RS_inst_dbg   (id_RS_inst_dbg),
        .id_RS_valid_dbg  (id_RS_valid_dbg),
        .RS_IS_NPC_dbg    (RS_IS_NPC_dbg),
        .RS_IS_inst_dbg   (RS_IS_inst_dbg),
        .RS_IS_valid_dbg  (RS_IS_valid_dbg),
        .Ex_C_NPC_dbg     (Ex_C_NPC_dbg),
        .Ex_C_inst_dbg    (Ex_C_inst_dbg),
        .Ex_C_valid_dbg   (Ex_C_valid_dbg)
