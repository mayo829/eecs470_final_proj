...
module t0();
    ...
    INST  [`SCALAR-1:0] inst;    // predict pc taken or no taken
    logic [`SCALAR-1:0] if_inst_valid;     
    ADDR  [`SCALAR-1:0]  bp_pc_out, bp_npc_out;
    EX_BP_PACKET [`SCALAR-1:0] ex_bp_packet_in;


    integer cnt,cnt_1;
    logic [`SCALAR-1:0] flag;
